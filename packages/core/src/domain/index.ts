...
export type { TaskCreateInput, TaskErrorCode, TaskItem, TaskMutationOptions, TaskResult, TaskStatus } from './taskboard/TaskBoard.ts'
export { projectMail, projectTasks, projectDelegations, projectMemory, roleScope, visibilityGeometry } from './scope/ScopeProjection.ts'
...
export type { MailProjection, MemberScope, ProjectContext, ProjectableMail, ProjectableTask, ProjectableMemory, ScopeLevel, TaskProjection, VisibilityGeometry } from './scope/ScopeProjection.ts'
export { MemoryStore, validateMemoryEntry } from './memory/MemoryStore.ts'
export type { MemoryEntry, MemoryInsertResult, MemoryKind, MemoryLevel } from './memory/MemoryStore.ts'
