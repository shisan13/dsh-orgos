...
| **官方能力派生(FR-D6)** | 成员内部用官方 DSH subagent(spawn/fork)与 workflow 工具派生;Codex/Claude Code 作为成员执行引擎走官方可选 Profile Bundle(预设内 disabled 行模板)——见 [架构与链路总览](docs/architecture.zh-CN.md) |
...
| 凭据与通道配置(所有 IM/文档 provider 的密钥位置与格式) | [docs/credentials-and-channels.zh-CN.md](docs/credentials-and-channels.zh-CN.md) |
